...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="flex justify-between items-center p-6 bg-gray-50 border-b">
            <h3 class="text-xl font-semibold text-gray-800">Daftar Jabatan</h3>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                                <a href="edit.php?id=<?php echo $row['id']; ?>" class="w-4 mr-2 transform text-blue-500 hover:text-blue-700 hover:scale-110">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="../../proses/jabatan/proses_hapus.php?id=<?php echo $row['id']; ?>" 
